...
void CXPButton::DrawItem(LPDRAWITEMSTRUCT lpDrawItemStruct)
{
	...
	hRgn1 = ::CreateRectRgn(0, 0, 2, 2);
	CombineRgn(hRgn, hRgn, hRgn1, RGN_DIFF);
	DeleteObject(hRgn1);

	hRgn1 = ::CreateRectRgn(rect.right-2, 0, rect.right, 2);
	CombineRgn(hRgn, hRgn, hRgn1, RGN_DIFF);
	DeleteObject(hRgn1);

	hRgn1 = ::CreateRectRgn(0, rect.bottom-2, 2, rect.bottom);
	CombineRgn(hRgn, hRgn, hRgn1, RGN_DIFF);
	DeleteObject(hRgn1);

	hRgn1 = ::CreateRectRgn(rect.right-2, rect.bottom-2, rect.right, rect.bottom);
	CombineRgn(hRgn, hRgn, hRgn1, RGN_DIFF);
	DeleteObject(hRgn1);
